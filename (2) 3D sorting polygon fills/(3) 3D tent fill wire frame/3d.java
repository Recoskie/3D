...
//back triangel
vertices[0]=new Point3D(-90,-90,90); //left botom corner
vertices[1]=new Point3D(90,-90,90); //right botom corner
vertices[2]=new Point3D(0,90,90); //top center corner
//front trangel
vertices[3]=new Point3D(-90,-90,-90); //left botom corner
vertices[4]=new Point3D(90,-90,-90); //right botom corner
vertices[5]=new Point3D(0,90,-90); //top center corner
...
JFrame f=new JFrame("Fill 3D Shapes");f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
...
//set the order to draw the sides for corected drawing
order=SetOrder(flat);
...
//calculate the difrent sides of what draws in the back or front algaritham created by damian recoskie
