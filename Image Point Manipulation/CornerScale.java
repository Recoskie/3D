...
public class CornerScale extends JPanel implements MouseMotionListener,MouseListener
{
BufferedImage a;
...
JFrame parent=new JFrame("Open");
chooser.setApproveButtonText("Open");
chooser.showDialog(chooser,null);
try{InputStream fin=new BufferedInputStream(new FileInputStream(chooser.getSelectedFile().toString()));
a=ImageIO.read(fin);}catch(Exception e){JOptionPane.showMessageDialog(null,"Image Formats Only "+e+"");}}
...
//CornerScale factor of pixle selection
...
//i nead it to draw left and right flip CornerScales as well
...
if(steep){g.fillRect(y,x,3,3);}

else{g.fillRect(x,y,3,3);}
