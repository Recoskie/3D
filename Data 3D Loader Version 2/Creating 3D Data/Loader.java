...
public int GetInt(BufferedInputStream i)
...
public int GetColor(BufferedInputStream i)
{int c=0;try{c=(i.read()&0x000000FF);}
catch(Exception e){}return(c);}

//**************************************************************************int to bytes

public byte[] GetBytes(int v){return((new byte[]{(byte)(v>>24),(byte)(v>>16),(byte)(v>>8),(byte)v}));}
