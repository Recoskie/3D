...
public class Rotation extends JPanel implements MouseMotionListener,MouseListener//,Runnable
{
BufferedImage a;float Rx=0,Ry=0;
int Px=0,Py=0,Pz=0;int azimuth=0,elevation=0;int mx=0,my=0;
public static int gw=1200,gh=1200;
int img[]=new int[gw*gh];

//i added the skip operation affter for faster graphics
