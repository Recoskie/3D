...
public static int gw=340,gh=300;
...
//}else{out[y][x]=new Point3D(0,0,0,0,0,0,0);}
...
{JFrame f=new JFrame("3D Modle By Damian Recoskie");
...
if(Data[L].length>i2+1){Y2=Data[L][i2+1][i3].y;Y2-=Y1;}

if(Y2<0){Y2-=2;Y1+=1;}else{Y2+=2;Y1-=1;}
if(X2<0){X2-=2;X1+=1;}else{X2+=2;X1-=1;}
...
//}else{Data[i][y][x]=new Points(0,0,0,0,0,0);}
