...
//3D points
int P[][]=new int[][]{{-50,50,-50},{50,50,-50},{-50,-50,-50},{50,-50,-50},
...
//my rotation functions integer angles not float point leaner type
//complete spead integer solution by damian recoskie

private int coscos(int size,int angle1,int angle2){try{angle1=CercularCerve(size,angle1);
